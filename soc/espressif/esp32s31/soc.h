...
/*
 * ESP32-S31 is dual-core, but this initial port only brings up the first
 * (PRO) core; there is no SMP support yet, so this always resolves to 0
 * like the equivalent helper on other single-image Espressif RISC-V ports.
 */
